																																																																																																																																																																	...
																																																																																																																																																																	<tr height=24 style='mso-height-source:userset;height:24.75pt'>
																																																																																																																																																																		...
																																																																																																																																																																		<tr height=24 style='mso-height-source:userset;height:24.0pt'>
																																																																																																																																																																			...
																																																																																																																																																																			<td class=xl114 style='border-left:none'>
																																																																																																																																																																				<?php if(($analysisedit['AnalysisData']['fdata'])!= NULL){ echo $analysisedit['AnalysisData']['fdate'];} ?>
																																																																																																																																																																				<?php if(($analysisedit['AnalysisData']['fdata']) == NULL){echo '<textarea wrap="soft" cols="8" rows="2" align="center" name="text24" id="text24"></textarea>';}  ?>
																																																																																																																																																																			</td>
																																																																																																																																																																			<td class=xl66></td>
																																																																																																																																																																			<td class=xl66></td>
																																																																																																																																																																			<td class=xl66></td>

...
<table border=0 cellpadding=0 cellspacing=0 width=1320 style='border-collapse:
 ...
 <tr height=18 style='mso-height-source:userset;height:18.0pt'>
  ...
  border-bottom:1.0pt solid black'>xxxx</td>
  <td class=xl66></td>
  <td class=xl66></td>
  <td class=xl66></td>
 </tr>
 ...
 <tr height=15 style='mso-height-source:userset;height:15.75pt'>
  ...
  none'>
  <textarea cols="40" wrap="soft" align="center" name="text1" id="text1"></textarea>
  </td>
  <td class=xl66></td>
  <td class=xl66></td>
  <td class=xl66></td>
 ...
 <tr height=15 style='mso-height-source:userset;height:15.75pt'>
  ...
  none'>
  <textarea cols="10" rows="5" wrap="soft" align="center" name="text2" id="text2"></textarea>
  </td>
  <td colspan=2 rowspan=2 class=xl132 style='border-right:1.0pt solid black;
  border-bottom:1.0pt solid black'>
 <textarea cols="10" rows="5" wrap="soft" align="center" name="text3" id="text3"></textarea>
  </td>
  <td colspan=2 rowspan=2 class=xl131 style='border-right:1.0pt solid black;
  border-bottom:1.0pt solid black'>
  <textarea cols="10" rows="5" wrap="soft" align="center" name="text4" id="text4"></textarea>
  </td>
 ...
 <tr height=51 style='mso-height-source:userset;height:51.0pt'>
  ...
  none'>
  <textarea cols="5" rows="3" wrap="soft" align="center" name="text6" id="text6"></textarea>
  </td>
  <td class=xl110 style='border-top:none;border-left:none'>
  <textarea cols="5" rows="3" wrap="soft" align="center" name="text7" id="text7"></textarea>
  </td>
  <td colspan=2 class=xl122 style='border-right:1.0pt solid black;border-left:
  none'> 
  <textarea cols="5" rows="3" wrap="soft" align="center" name="text8" id="text8"></textarea>
  </td>
  <td colspan=2 class=xl122 style='border-right:1.0pt solid black;border-left:
  none'>
  <textarea cols="5" rows="3" wrap="soft" align="center" name="text9" id="text9"></textarea>
  </td>
  <td class=xl66></td>
  <td class=xl66></td>
  <td class=xl66></td>
 ...
 <tr height=17 style='mso-height-source:userset;height:17.25pt'>
  ...
  <textarea wrap="soft" align="center" name="text11" id="text11"></textarea>
  </td>
  <td colspan=2 class=xl111 style='border-right:1.0pt solid black'>
  <textarea wrap="soft" align="center" name="text12" id="text12"></textarea>
  </td>
  <td colspan=2 class=xl177 style='border-right:1.0pt solid black;border-left:
  none'>
  <textarea wrap="soft" align="center" name="text13" id="text13"></textarea>
  </td>
  <td colspan=2 class=xl177 style='border-right:1.0pt solid black;border-left:
  none'>
  <textarea wrap="soft" cols="12" align="center" name="text14" id="text14"></textarea>
  </td>
  <td class=xl112 style='border-left:none'>
  <textarea wrap="soft" cols="11" align="center" name="text15" id="text15"></textarea>
  </td>
  <td colspan=2 class=xl177 style='border-right:1.0pt solid black;border-left:
  none'>
  <textarea wrap="soft" cols="17" align="center" name="text16" id="text16"></textarea>
  </td>
  <td colspan=2 class=xl177 style='border-right:1.0pt solid black;border-left:
  none'>
  <textarea wrap="soft" cols="17" align="center" name="text17" id="text17"></textarea>
   </td>
  <td class=xl67></td>
  <td class=xl66></td>
  <td class=xl66></td>
 ...
 <tr height=24 style='mso-height-source:userset;height:24.0pt'>
  ...
  <textarea wrap="soft"  cols="15" rows="2" align="center" name="text28" id="text28"></textarea>
  </td>
 ...
 <tr height=21 style='height:21.0pt'>
  ...
  <input type="text" name="text49" id="text49">
  </td>
  <td class=xl66></td>
  <td class=xl66></td>
  <td class=xl66></td>
 ...
 <tr height=14 style='mso-height-source:userset;height:14.0pt'>
  ...
  border-bottom:1.0pt solid black'>
  <textarea wrap="soft" cols="150" rows="5" align="center" name="text51" id="text51"></textarea>
  </td>
  <td class=xl66></td>
  <td class=xl66></td>
  <td class=xl66></td>
